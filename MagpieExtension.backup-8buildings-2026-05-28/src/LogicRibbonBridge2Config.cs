    ...
    public class LogicRibbonBridge2Config : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef(
                ID, 4, 1, "logicribbon_bridge2", 30, 30f,
            ...
            def.UtilityInputOffset = new CellOffset(0, 0); def.UtilityOutputOffset = new CellOffset(3, 0);
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            if (link != null) { link.link1 = new CellOffset(0, 0); link.link2 = new CellOffset(3, 0); }
        }
    }
}
