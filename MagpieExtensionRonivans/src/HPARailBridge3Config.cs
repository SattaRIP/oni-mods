...
{
    public class HPARailBridge3Config : IBuildingConfig
    {
        public const string ID = "HPARailBridge3";
        private static readonly IBuildingConfig BaseConfig = RonivansHelpers.CreateBaseConfig(HPARailBridge2Config.BASE_TYPE);
